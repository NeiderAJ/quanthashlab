// src/components/ChatIA/SimpleChatInterface.jsx - VERSIÓN COMPLETA Y VERIFICADA
...
const SimpleChatInterface = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://quanthashlab-backend-service-1041762989408.us-central1.run.app/api/analyze', {
        method: 'POST',
